...
export default function UserMaterialsPage({ resources, username, department, onLogout }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", display: "flex" }}>
      {/* Sidebar */}
      <aside style={{ width: 192, background: "rgba(255,255,255,0.85)", backdropFilter: "blur(12px)", borderRight: "1px solid #e5e7eb", display: "flex", flexDirection: "column", padding: "1.5rem 1rem", gap: 6, flexShrink: 0 }}>
