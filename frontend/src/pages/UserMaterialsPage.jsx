...
export default function UserMaterialsPage({ resources, username, department, onLogout }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", display: "flex", overflow: "hidden", maxWidth: "100vw" }} className="materials-root">
      {/* Sidebar */}
      <aside className="materials-sidebar" style={{ width: 192, background: "rgba(255,255,255,0.85)", backdropFilter: "blur(12px)", borderRight: "1px solid #e5e7eb", display: "none", flexDirection: "column", padding: "1.5rem 1rem", gap: 6, flexShrink: 0 }}>
